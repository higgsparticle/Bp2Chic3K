...
Bp_tuple = TupleSelection (
    'TUPLE',
    [ SelMyBp], 
    Decay = '[B+ -> ^(chi_c1(1P) -> ^(J/psi(1S) -> ^mu+ ^mu-) ^gamma) ^K+]CC',
    Branches = { 
          "Bp" : "[B+ ->  (chi_c1(1P) ->  (J/psi(1S) ->  mu+  mu-)  gamma)  K+]CC",
          ...
          "kaonp1"    : "[B+ ->  (chi_c1(1P) ->  (J/psi(1S) ->  mu+  mu-)  gamma) ^K+]CC",
          } 
)

mytuple = Bp_tuple.algorithm()
mytuple.ToolList = tupletools[:]
for particle in ["Bp", "chi_c", "gamma", "Jpsi", "muplus", "muminus", "kaonp1"]:
...
for tup in tuples:
    ...
    chic2Const.Substitutions = { 'Beauty -> ^chi_c1(1P) Meson': 'chi_c2(1P)' }
    ...
    chic2BpConst.Substitutions = { 'Beauty -> ^chi_c1(1P) Meson': 'chi_c2(1P)' }
    ...
    chic2ConstNoPV.Substitutions = { 'Beauty -> ^chi_c1(1P) Meson': 'chi_c2(1P)' }
    ...
    chic2BpConstNoPV.Substitutions = { 'Beauty -> ^chi_c1(1P) Meson': 'chi_c2(1P)' }
